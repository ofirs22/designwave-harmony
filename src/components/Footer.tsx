      ...
      <div className="w-full bg-[#EBEBEB] py-4">
        <div className="container mx-auto px-4 flex flex-col-reverse gap-4 sm:flex-row sm:justify-between sm:items-center">
          ...
          <div className="flex justify-center sm:justify-start gap-4">
            <img src="/assets/visa.png" alt="Visa" className="w-[35px] h-[26px] md:w-[42px] md:h-[31px]" />
            <img src="/assets/mc.png" alt="MasterCard" className="w-[35px] h-[26px] md:w-[42px] md:h-[31px]" />
            <img src="/assets/paypal.png" alt="PayPal" className="w-[35px] h-[26px] md:w-[42px] md:h-[31px]" />
          </div>
        </div>
      </div>
    </footer>
