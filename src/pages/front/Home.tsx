...
import WeekSpecial from '../../components/homepage/WeekSpecial';
import SuppliersBanner from '../../components/homepage/SuppliersBanner';
import Banners from '../../components/homepage/Banners';
import ItemsWithCategories from '../../components/homepage/ItemsWithCategories';
...
const Home: React.FC = () => {
  return (
    <main className="min-h-screen bg-[#f4f5f5]">
      ...
      {/* SubscribeBanner Section - Full Width */}
      <div className="w-full">
        <SubscribeBanner />
      </div>
    </main>
